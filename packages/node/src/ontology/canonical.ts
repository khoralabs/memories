 ...
 *
 * @deprecated Import family exports from `@khoralabs/memories-node/ontology/families/*`
 * or `@khoralabs/memories-node/ontology` and assemble an app-specific ontology.
 */
