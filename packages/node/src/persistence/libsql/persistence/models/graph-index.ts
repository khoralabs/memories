...
async function countSuppressedNodes(db: LibsqlDatabase, namespace: string): Promise<number> {
...
async function countSuppressedEdges(db: LibsqlDatabase, namespace: string): Promise<number> {
