...
export async function insertEdgeLabelAssignment(
  ...
  await ctxExec(
    ...
    [assignmentId, ctx.now, input.edgeId, input.labelId, serializeProps(input.props)],
  );
}
