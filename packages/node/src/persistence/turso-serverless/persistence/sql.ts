...
/**
 * Tantivy query string: AND-combined whitespace-separated tokens as phrase terms.
 * Same builder as the SQLite reference (porter stemming comes from the index).
 */
