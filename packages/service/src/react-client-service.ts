 ...
 * Do not import this entry from browser UI bundles — use `@khoralabs/memories-service/react-client`
 * for types and implement {@link ReactMemoriesClient} (or import this peel from a
